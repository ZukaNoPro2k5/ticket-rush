...
export function EventsResultsBar({
  loading, totalCount, sort, view, onSortChange, onViewChange,
}: Props) {
  return (
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex h-10 items-center gap-0.5 rounded-full border border-stone-200 bg-white p-0.5">
          <button
            ...
            className={`grid h-9 w-9 place-items-center rounded-full transition-colors ${view === 'grid' ? 'bg-stone-900 text-white' : 'text-stone-500 hover:text-stone-900'}`}
          >
          ...
          <button
            ...
            className={`grid h-9 w-9 place-items-center rounded-full transition-colors ${view === 'list' ? 'bg-stone-900 text-white' : 'text-stone-500 hover:text-stone-900'}`}
          >
